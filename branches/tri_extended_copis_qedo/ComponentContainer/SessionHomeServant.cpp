...
#ifndef _QEDO_NO_QOS
void
SessionHomeServant::set_servant_interceptor_dispatcher(Qedo_Components::ServantInterceptorDispatcher_ptr servant_dispatcher)
{
	servant_dispatcher_ = servant_dispatcher;
}
void

SessionHomeServant::set_stub_interceptor_dispatcher(Qedo_Components::StubInterceptorDispatcher_ptr  stub_dispatcher)
{
