 ...
 * @author eduardw
 */
public class OperationDefAction extends SelectionAction {

//	 The command type as string value
    private final String commandType;

    // The name shown in the Context-Menu
    public static final String CLASSIFIER_PROPERTY = "add operation";
     ...
     * @param commandType
     */
    public OperationDefAction(IWorkbenchPart part, String commandType){
        super(part);
    ...
    protected Command createOperatonCommand(List selectedEditParts){
        ...
        if (part instanceof InterfaceDefNodeEditPart ||
            ...
            AddOperationDefRequest req = new AddOperationDefRequest(getCommandType());
    		if (!part.understandsRequest(req)) return null;
    		else {
    			ModelFactory mf = new ModelFactory();
    			AddOperationDefCommand command = 
    				(AddOperationDefCommand) part.getCommand(req);
    			...
    			command.setNewObject(factory.createOperationDef());
