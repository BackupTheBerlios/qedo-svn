...
public class HomeInstanceNodeEditPart
     ...
     * @param node
     */
    public HomeInstanceNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public HomeInstanceNodeEditPart(){}
	
	public HomeInstantiation getHomeInstance(){
		return (HomeInstantiation)((Node) getModel()).getContained();
	}
    
	/*
	 * return the figure casted to CORBAComponent
	 */
	public ContainerFigureWithAttribute getHomeInstanceFigure(){
	...
	protected void refreshVisuals() {
		...
		ContainerFigureWithAttribute fig = getHomeInstanceFigure();
		fig.setName(getHomeInstance().getIdentifier());
    ...
    public IFigure getContentPane() {
        return getHomeInstanceFigure().getAttributeFigure();
    }
 ...
 public ConnectionAnchor getSourceConnectionAnchor(ConnectionEditPart connection) {
     return getHomeInstanceFigure().getIncomingConnectionAnchor();
 }
 ...
 public ConnectionAnchor getTargetConnectionAnchor(ConnectionEditPart connection) {
     return getHomeInstanceFigure().getOutgoingConnectionAnchor();
 }
