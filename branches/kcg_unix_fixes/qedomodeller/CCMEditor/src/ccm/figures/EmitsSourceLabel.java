 ...
 */
public class EmitsSourceLabel extends PortLabel {

	public EmitsSourceLabel() {
		super();
	...
	protected void makeBottomLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EMITTERSOURCE_BOTTOM)));
	...
	protected void makeLeftLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EMITTERSOURCE_LEFT)));
	...
	protected void makeRightLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EMITTERSOURCE_RIGHT)));
	...
	protected void makeTopLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EMITTERSOURCE_TOP)));
		super.makeTopLayout();
	}
}
