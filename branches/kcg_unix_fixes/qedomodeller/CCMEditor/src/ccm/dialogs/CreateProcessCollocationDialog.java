...
*@author Siegercn
*/
public class CreateProcessCollocationDialog extends org.eclipse.swt.widgets.Dialog {
	...
	public CreateProcessCollocationDialog(Shell parent, int style) {
		super(parent, style);
		this.parent=parent;
	}
	...
	*/
	public void open(){
		...
		//	idlTypeCmb = new Combo(composite2,SWT.READ_ONLY);
			...
			dialogShell.setText("Add ProcessCollocation");
			...
			constValueLb.setText("Destination:");
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateProcessCollocationDialog inst = new CreateProcessCollocationDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
