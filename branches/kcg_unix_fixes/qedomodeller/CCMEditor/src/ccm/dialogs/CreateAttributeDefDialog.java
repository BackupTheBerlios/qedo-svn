...
*/
public class CreateAttributeDefDialog extends org.eclipse.swt.widgets.Dialog  implements KeyListener{
	private Button idlBtn;
	private Button isReadonlyBtn;
	...
	public CreateAttributeDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	protected void enterMouseDown(MouseEvent evt){
	    ...
	    isReadOnly=isReadonlyBtn.getSelection();
	    state=true;
	    dialogShell.close();
	}
	...
	*/
	public void open(){
		try {
			...
			isReadonlyBtn = new Button(composite2,SWT.CHECK| SWT.RIGHT);
			...
			dialogShell.setSize(new org.eclipse.swt.graphics.Point(476,200));
			...
			idlBtnLData.bottom =  new FormAttachment(722, 1000, 0);
			...
			FormData isReadonlyBtnLData = new FormData();
			isReadonlyBtnLData.height = 20;
			isReadonlyBtnLData.width = 110;
			isReadonlyBtnLData.left =  new FormAttachment(247, 1000, 0);
			isReadonlyBtnLData.right =  new FormAttachment(500, 1000, 0);
			isReadonlyBtnLData.top =  new FormAttachment(740, 1000, 0);
			isReadonlyBtnLData.bottom =  new FormAttachment(916, 1000, 0);
			isReadonlyBtn.setLayoutData(isReadonlyBtnLData);
			isReadonlyBtn.setAlignment(SWT.LEFT);
			isReadonlyBtn.setText("is only read");
			isReadonlyBtn.setSize(new org.eclipse.swt.graphics.Point(110,20));
			isReadonlyBtn.setEnabled(true);
			isReadonlyBtn.setFont(idlBtnfont);
	
			FormData idlTypeCmbLData = new FormData();
			idlTypeCmbLData.height = 24;
			idlTypeCmbLData.width = 306;
			idlTypeCmbLData.left =  new FormAttachment(247, 1000, 0);
			idlTypeCmbLData.right =  new FormAttachment(936, 1000, 0);
			idlTypeCmbLData.top =  new FormAttachment(525, 1000, 0);
			idlTypeCmbLData.bottom =  new FormAttachment(672, 1000, 0);
			idlTypeCmb.setLayoutData(idlTypeCmbLData);
			idlTypeCmb.setSize(new org.eclipse.swt.graphics.Point(306,24));
			...
			repositoryIdTxtLData.left =  new FormAttachment(247, 1000, 0);
			...
			versionTxtLData.left =  new FormAttachment(247, 1000, 0);
			...
			identifierTxtLData.left =  new FormAttachment(247, 1000, 0);
			...
			versionLbLData.right =  new FormAttachment(239, 1000, 0);
			...
			repositoryIdLbLData.right =  new FormAttachment(239, 1000, 0);
			...
			idLbLData.right =  new FormAttachment(239, 1000, 0);
			...
			cancelLData.top =  new FormAttachment(336, 1000, 0);
			cancelLData.bottom =  new FormAttachment(880, 1000, 0);
			...
			enterLData.top =  new FormAttachment(336, 1000, 0);
			enterLData.bottom =  new FormAttachment(880, 1000, 0);
			...
			Rectangle bounds = dialogShell.computeTrim(0, 0, 476,200);
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateAttributeDefDialog inst = new CreateAttributeDefDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
