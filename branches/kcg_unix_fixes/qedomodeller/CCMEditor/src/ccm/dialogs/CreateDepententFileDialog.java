...
*@author Siegercn
*/
public class CreateDepententFileDialog extends org.eclipse.swt.widgets.Dialog {
	...
	private Combo cardinalityString;
	private Composite composite2;
	private Aktionkind kind; 
	private Aktionkind[]kinds= {Aktionkind.ASSERT_LITERAL,Aktionkind.INSTALL_LITERAL};
	...
	public CreateDepententFileDialog(Shell parent, int style) {
		super(parent, style);
	...
	*/
	public void open(){
		try {
			...
			cardinalityString =new Combo(composite2,SWT.READ_ONLY);
		//	idlTypeCmb = new Combo(composite2,SWT.READ_ONLY);
			...
			dialogShell.setText("Add Dependent File");
			...
			cardinalityString.addSelectionListener( new SelectionAdapter() {
				public void widgetSelected(SelectionEvent evt) {
					cardinalityStringWidgetSelected(evt);
				}
			});
	 ...
	 * @param evt
	 */
	protected void cardinalityStringWidgetSelected(SelectionEvent evt) {
		kind=kinds[cardinalityString.getSelectionIndex()];
	...
	public void postInitGUI(){
	    ...
	    cardinalityString.add("ASSERT");
		cardinalityString.add("INSTALL");
		cardinalityString.select(0);
	}
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateDepententFileDialog inst = new CreateDepententFileDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
