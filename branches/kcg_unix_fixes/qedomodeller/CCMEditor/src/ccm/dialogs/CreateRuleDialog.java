...
*@author Siegercn
*/
public class CreateRuleDialog extends org.eclipse.swt.widgets.Dialog {
		private Text objectrefTxt;
	   ...
	   // private Shell parent ;
		...
		public CreateRuleDialog(Shell parent, int style) {
			super(parent, style);
			//this.parent=parent;
		}
		...
		*/
		public void open(){
			try {
				...
				idlTypeCmb = new Text(composite2,SWT.BORDER);
				idlTypeLb = new Label(composite2,SWT.NULL);
				
				objectrefTxt=new Text(composite2,SWT.BORDER);
				...
				dialogShell.setText("Add Rule");
				dialogShell.setSize(new org.eclipse.swt.graphics.Point(492,190));
		
				
				GridData composite2LData = new GridData();
				composite2LData.verticalAlignment = GridData.CENTER;
				composite2LData.horizontalAlignment = GridData.BEGINNING;
				composite2LData.widthHint = 480;
				...
				composite2.setSize(new org.eclipse.swt.graphics.Point(480,146));
				...
				FormData  TxtLData = new FormData();
				 TxtLData.height = 13;
				 TxtLData.width = 342;
				 TxtLData.left =  new FormAttachment(246, 1000, 0);
				 TxtLData.right =  new FormAttachment(996, 1000, 0);
				 TxtLData.top =  new FormAttachment(880, 1100, 0);
				 TxtLData.bottom =  new FormAttachment(1040, 1100, 0);
				 ...
				 LbLData.right =  new FormAttachment(260, 1000, 0);
				 LbLData.top =  new FormAttachment(888, 1100, 0);
				 LbLData.bottom =  new FormAttachment(1040, 1100, 0);
				constValueLb.setLayoutData( LbLData);
				constValueLb.setText("Action:");
				...
				constValueTxtLData.left =  new FormAttachment(246, 1000, 0);
				constValueTxtLData.right =  new FormAttachment(996, 1000, 0);
				constValueTxtLData.top =  new FormAttachment(525, 1100, 0);
				constValueTxtLData.bottom =  new FormAttachment(672, 1100, 0);
				...
				objectrefTxt.addKeyListener( new KeyAdapter() {
					public void keyReleased(KeyEvent evt) {
						objectrefTxtKeyReleased(evt);
					}
				});
				...
				constValueLbLData.top =  new FormAttachment(538, 1100, 0);
				constValueLbLData.bottom =  new FormAttachment(672, 1100, 0);
				objectRefLb.setLayoutData(constValueLbLData);
				objectRefLb.setText("Condition:");
				...
				idlTypeCmbLData.left =  new FormAttachment(246, 1000, 0);
				idlTypeCmbLData.right =  new FormAttachment(996, 1000, 0);
				idlTypeCmbLData.top =  new FormAttachment(700, 1100, 0);
				idlTypeCmbLData.bottom =  new FormAttachment(840, 1100, 0);
				idlTypeCmb.setLayoutData(idlTypeCmbLData);
				idlTypeCmb.setSize(new org.eclipse.swt.graphics.Point(306,20));
				idlTypeCmb.setFont(constValueTxtfont);
				idlTypeCmb.addKeyListener( new KeyAdapter() {
					public void keyReleased(KeyEvent evt) {
						idlTypeCmbKeyReleased(evt);
					}
				});
				...
				idlTypeLbLData.right =  new FormAttachment(241, 1000, 0);
				idlTypeLbLData.top =  new FormAttachment(702, 1100, 0);
				idlTypeLbLData.bottom =  new FormAttachment(840, 1100, 0);
				idlTypeLb.setLayoutData(idlTypeLbLData);
				idlTypeLb.setText("Languaage:");
				...
				repositoryIdTxtLData.left =  new FormAttachment(246, 1000, 0);
				repositoryIdTxtLData.right =  new FormAttachment(996, 1000, 0);
				repositoryIdTxtLData.top =  new FormAttachment(202, 1100, 0);
				repositoryIdTxtLData.bottom =  new FormAttachment(349, 1100, 0);
				...
				versionTxtLData.left =  new FormAttachment(246, 1000, 0);
				versionTxtLData.right =  new FormAttachment(996, 1000, 0);
				versionTxtLData.top =  new FormAttachment(363, 1100, 0);
				versionTxtLData.bottom =  new FormAttachment(511, 1100, 0);
				...
				identifierTxtLData.left =  new FormAttachment(246, 1000, 0);
				identifierTxtLData.right =  new FormAttachment(996, 1000, 0);
				identifierTxtLData.top =  new FormAttachment(37, 1100, 0);
				identifierTxtLData.bottom =  new FormAttachment(187, 1100, 0);
				...
				versionLbLData.top =  new FormAttachment(373, 1100, 0);
				versionLbLData.bottom =  new FormAttachment(511, 1100, 0);
				...
				repositoryIdLbLData.top =  new FormAttachment(212, 1100, 0);
				repositoryIdLbLData.bottom =  new FormAttachment(349, 1100, 0);
				...
				idLbLData.top =  new FormAttachment(40, 1100, 0);
				idLbLData.bottom =  new FormAttachment(187, 1100, 0);
				...
				Rectangle bounds = dialogShell.computeTrim(0, 0, 492,190);
		 ...
		 * @param evt
		 */
		protected void idlTypeCmbKeyReleased(KeyEvent evt) {
			entrypoint=idlTypeCmb.getText(); 
		...
		protected void objectrefTxtKeyReleased(KeyEvent evt) {
			objectRef=objectrefTxt.getText();
	...
	//	}
		...
		public void postInitGUI(){
		    ...
		    constValueTxt.setText(regName);
		    objectrefTxt.setText(objectRef);
		    idlTypeCmb.setText(entrypoint);
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreateRuleDialog inst = new CreateRuleDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
	    ...
	    public void setCondition(String condition) {
	        this.objectRef = condition;
	    }
	    public void setLanguage(String language) {
	        this.entrypoint = language;
	    }
