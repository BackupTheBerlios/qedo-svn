...
*@author Siegercn
*/
public class CreateHomeInstanceDialog extends org.eclipse.swt.widgets.Dialog {
		...
		public CreateHomeInstanceDialog(Shell parent, int style) {
			super(parent, style);
			this.parent=parent;
		}
		...
		*/
		public void open(){
			try {
				...
				dialogShell.setText("Add HomeInstance");
				...
				FormData CmbLData = new FormData();
				 CmbLData.height = 20;
				 CmbLData.width = 306;
				 CmbLData.left =  new FormAttachment(262, 1000, 0);
				...
				idlTypeLbLData1.right =  new FormAttachment(261, 1000, 0);
				...
				objectRefLb.setText("Cardinality:");
		...
		protected void implCmbWidgetSelected(SelectionEvent evt) {
			setImpl((Implementation)implList.get(implCmb.getSelectionIndex()));
		 ...
		 */
		private void setImpl(Implementation implementation) {
			impl=implementation;
	...
	//	}
		...
		public void postInitGUI(){
		    ...
		    Iterator it=implList.iterator();
		 	while(it.hasNext()){
				Object o=it.next();
				implCmb.add(((Implementation)o).getIdentifier());
		 	}
		}
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreateHomeInstanceDialog inst = new CreateHomeInstanceDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
	    ...
	    public void SetImpls(List impls){
	    	this.implList=impls;
