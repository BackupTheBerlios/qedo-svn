...
To install MICO you have to do at least the following steps.
\begin{itemize}
...
Then you need to build the whole solution. This will automatically install the code generator (\verb cidl_gen ) in the bin directry under the Qedo installation directory pointed to by the \verb QEDO  environment var.
