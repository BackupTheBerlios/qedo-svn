...
static char rcsid[] = "$Id: SourcePort.cpp,v 1.1.2.1 2003/09/26 14:26:02 stoinski Exp $";
...
: DispatcherEntry (entry),
  buffer_ (StreamComponents::StreamingBuffer::_duplicate (entry.buffer_))
{
}
...
throw (StreamComponents::UnsupportedStreamtype, StreamComponents::DuplicateStream)
{
	...
	for (unsigned int i = 0; i < streamtypes_->length(); i++)
	{
#ifdef MICO_ORB
