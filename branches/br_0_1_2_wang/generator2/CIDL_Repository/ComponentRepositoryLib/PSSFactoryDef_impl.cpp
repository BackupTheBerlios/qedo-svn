...
void
PSSFactoryDef_impl::destroy
()
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::destroy() called" );
}

CORBA::TypeCode_ptr
PSSFactoryDef_impl::result
()
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::result() called" );
...
void
PSSFactoryDef_impl::result_def
(IR__::IDLType_ptr idl_type)
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::result_def(...) called" );
...
void
PSSFactoryDef_impl::params
(const IR__::ParDescriptionSeq& seq)
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::params(...) called" );
...
void
PSSFactoryDef_impl::mode
(IR__::OperationMode mode)
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::mode(...) called" );
...
void
PSSFactoryDef_impl::contexts
(const IR__::ContextIdSeq& seq)
throw(CORBA::SystemException)
{
	DEBUG_OUTLINE ( "PSSFactoryDef_impl::contexts(...) called" );
