							 ...
							 public virtual Contained_impl
{
	...
	CIDL::AbsStHomeDelegationSeq abs_st_home_delegations_;
...
public:
	...
	//
    // IDL:omg.org/CIDL/HomeExecutorDef/abs_st_home_delegations:1.0
    //
    virtual CIDL::AbsStHomeDelegationSeq* abs_st_home_delegations()
		throw(CORBA::SystemException);
    virtual void abs_st_home_delegations(const CIDL::AbsStHomeDelegationSeq&)
		throw(CORBA::SystemException);
