...
*@author Siegercn
*/
public class CreateDeploymenRequirementDialog extends org.eclipse.swt.widgets.Dialog {
	...
	public CreateDeploymenRequirementDialog(Shell parent, int style) {
		super(parent, style);
	...
	*/
	public void open(){
		...
		//	idlTypeCmb = new Combo(composite2,SWT.READ_ONLY);
			...
			dialogShell.setText("Add DeploymentRequirement");
			...
			idlTypeLbLData.right =  new FormAttachment(248, 1000, 0);
	...
	protected void cardinalityTxtKeyReleased(KeyEvent evt) {
			...
			reqVersion= cardinalityString.getText();
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateDeploymenRequirementDialog inst = new CreateDeploymenRequirementDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
