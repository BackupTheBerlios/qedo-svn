...
*@author Siegercn
*/
public class CreateCompositionDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	private ComponentCategory[] categorys={ComponentCategory.PROCESS_LITERAL,ComponentCategory.SESSION_LITERAL,
			                                   ComponentCategory.ENTITY_LITERAL,ComponentCategory.SERVICE_LITERAL};
	...
	public CreateCompositionDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Add Composition");
			...
			discriminatorTypeLb.setText("Category:");
	...
	public void postInitGUI(){
	    ...
	    discTypeCmb.add("PROCESS");
	    discTypeCmb.add("SESSION");
	    discTypeCmb.add("ENTITY");
	    discTypeCmb.add("SERVICE");
