...
*@author Siegercn
*/
public class CreateContainedFileDialog extends org.eclipse.swt.widgets.Dialog {
		...
		public CreateContainedFileDialog(Shell parent, int style) {
			super(parent, style);
		...
		*/
		public void open(){
			try {
				...
				dialogShell.setText("Add Contained File");
				dialogShell.setSize(new org.eclipse.swt.graphics.Point(492,216));
				...
				composite2.setSize(new org.eclipse.swt.graphics.Point(480,160));
				...
				FormData  locationTxtLData = new FormData();
				locationTxtLData.height = 20;
				locationTxtLData.width = 342;
				locationTxtLData.left =  new FormAttachment(262, 1000, 0);
				locationTxtLData.right =  new FormAttachment(996, 1000, 0);
				locationTxtLData.top =  new FormAttachment(1060, 1200, 0);
				locationTxtLData.bottom =  new FormAttachment(1200, 1200, 0);
				 locationTxt.setLayoutData( locationTxtLData);		
				 locationTxt.setFont(constValueTxtfont);
				 locationTxt.setSize(new org.eclipse.swt.graphics.Point(342,20));
				 ...
				 LbLData.top =  new FormAttachment(1060, 1200, 0);
				 LbLData.bottom =  new FormAttachment(1200, 1200, 0);
				...
				FormData TxtLData = new FormData();
				 ...
				 LbLData = new FormData();
				 LbLData.height = 20;
				 LbLData.width = 100;
			     LbLData.left =  new FormAttachment(11, 1000, 0);
				 LbLData.right =  new FormAttachment(260, 1000, 0);
				 LbLData.top =  new FormAttachment(878, 1200, 0);
				 LbLData.bottom =  new FormAttachment(1040, 1200, 0);
				constValueLb.setLayoutData( LbLData);
				constValueLb.setText("EntrypointUsage:");
				...
				constValueTxtLData.left =  new FormAttachment(262, 1000, 0);
				...
				idlTypeCmbLData.left =  new FormAttachment(262, 1000, 0);
				...
				repositoryIdTxtLData.left =  new FormAttachment(262, 1000, 0);
				...
				versionTxtLData.left =  new FormAttachment(262, 1000, 0);
				...
				identifierTxtLData.left =  new FormAttachment(262, 1000, 0);
				...
				composite3.setSize(new org.eclipse.swt.graphics.Point(480,45));
		
				FormData cancelLData = new FormData();
				cancelLData.height = 24;
				cancelLData.width = 80;
				cancelLData.left =  new FormAttachment(836, 1000, 0);
				cancelLData.right =  new FormAttachment(988, 1000, 0);
				cancelLData.top =  new FormAttachment( 200, 1000, 0);
				cancelLData.bottom =  new FormAttachment(780, 1000, 0);
				...
				enterLData.right =  new FormAttachment(775, 1000, 0);
				enterLData.top =  new FormAttachment( 200, 1000, 0);
				enterLData.bottom =  new FormAttachment(780, 1000, 0);
				...
				Rectangle bounds = dialogShell.computeTrim(0, 0, 492,216);
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreateContainedFileDialog inst = new CreateContainedFileDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
	     ...
	     */
	    public String getEntrypointUsage() {
	        return regName;
	    }
