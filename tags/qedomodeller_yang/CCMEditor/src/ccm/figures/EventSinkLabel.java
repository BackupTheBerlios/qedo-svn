 ...
 */
public class EventSinkLabel extends PortLabel {
	
	public EventSinkLabel() {
		super();
	...
	protected void makeBottomLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EVENTSINK_BOTTOM)));
	...
	protected void makeLeftLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EVENTSINK_LEFT)));
	...
	protected void makeRightLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EVENTSINK_RIGHT)));
	...
	protected void makeTopLayout() {
		icon.setImage(new Image(null, 
				CCMEditorPlugin.class.getResourceAsStream(ProjectResources.EVENTSINK_TOP)));
		super.makeTopLayout();
	}
