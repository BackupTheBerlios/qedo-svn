 ...
 * @author vilapower
 */
public class ValueSupportsConnectCommand extends Command {
	 ...
	 */			
	public ValueSupportsConnectCommand() {
		super();
	}
	/**
	 * @see org.eclipse.gef.commands.Command
	 */			
	public ValueSupportsConnectCommand(String s) {
		super(s);
	}
	...
	*/
	public void execute() {
	  ...
	  //  relation=factory.createSupportsRelation();
	    ...
	    value=(ValueDef) source.getContained();
	...
	protected void createConnection(){	
		value.getValueSupports_itf().add(itf);
	  //  itf.getSupportsRelation().add(relation);
	  //  value.setSupportsRelation(relation);
