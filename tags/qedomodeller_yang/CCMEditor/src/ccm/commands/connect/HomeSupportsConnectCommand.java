 ...
 * @author vilapower
 */
public class HomeSupportsConnectCommand extends Command {
	 ...
	 */			
	public HomeSupportsConnectCommand() {
		super();
	 ...
	 * @see org.eclipse.gef.commands.Command
	 */			
	public HomeSupportsConnectCommand(String s) {
		super(s);
	...
	*/
	public void execute() {
	   ...
	   // relation=factory.createSupportsRelation();
	    ...
	    home=(HomeDef) source.getContained();
	...
	protected void createConnection(){	
		...
		//itf.getHomes().add(home);
		home.getHomeSupports_itf().add(itf);
	    //home.getSupportsRelation().add(relation);
