...
public class AssemblyXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	//*******************************************************************		
		...
		Command	createCommand = null;
		  if(newObjectType==ProcessCollocation.class){
			Dimension dim=request.getSize();
			if(dim==null)dim=new Dimension(200,260);
			CreateNodeForProcessCollocationCommand create=new CreateNodeForProcessCollocationCommand();
	...
	private void initilizeCommandForContainer(CreateNodeForProcessCollocationCommand command,
