...
#ifndef __CONSUMES_DEF_IMPL_H__
#define __CONSUMES_DEF_IMPL_H__
...
class ConsumesDef_impl : public virtual POA_IR__::ConsumesDef,
						  public virtual EventPortDef_impl
{
public:
	ConsumesDef_impl ( Container_impl *container,
