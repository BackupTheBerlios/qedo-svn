...
# ADD LINK32 ComponentIDL.lib CosNamingd.lib obd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../Runtime/tc.exe" /pdbtype:sept /libpath:"$(ORBACUS)\lib" /libpath:"$(QEDO)/ComponentIDL/ComponentIDL___Win32_Debug_orbacus_vc6/"
