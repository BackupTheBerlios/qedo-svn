...
#ifndef __GENERATOR_VALUETYPESC_H__
#define __GENERATOR_VALUETYPESC_H__
...
class GeneratorValuetypesC : public virtual CPPBase
{
...
private:
	...
	bool generateMemberInit(IR__::ValueDef_ptr value, bool comma);
