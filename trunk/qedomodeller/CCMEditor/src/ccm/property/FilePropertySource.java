 ...
 *
 */
public class FilePropertySource extends ContainedPropertySource {

    protected File abstObj;
     ...
     */
    public FilePropertySource(Contained element) {
        	super(element);
        	abstObj=(File) element;
    ...
    //	PropertyDescriptor fileName = new TextPropertyDescriptor(Integer.toString(100), "fileName");
   // 	fileName.setCategory(cat);
    //    descriptors.add(fileName);    
        PropertyDescriptor location = new TextPropertyDescriptor(Integer.toString(101), "location");
    ...
    public void setPropertyValue(Object id, Object value) {
	    ...
	    case 100:
	       abstObj.setName((String)value); 
	    	break;
	    case 101:
		       abstObj.setLocation((String)value); 
		    	break;
