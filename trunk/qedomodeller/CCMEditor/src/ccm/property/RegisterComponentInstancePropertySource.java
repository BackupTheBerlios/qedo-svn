 ...
 *
 */
public class RegisterComponentInstancePropertySource extends ContainedPropertySource {

    protected RegisterComponentInstance register;
     ...
     */
    public RegisterComponentInstancePropertySource(Contained element) {
        	super(element);
        	register=(RegisterComponentInstance) element;
    ...
    public Object getPropertyValue(Object id) {
	    ...
	    case 107:
	    	return ((Contained)register.getFeature()).getIdentifier();
	   
	    case 108:
	    	return register.getRegName();
	    case 109:
	    	return new Integer(services.indexOf(register.getService()));
    ...
    public void setPropertyValue(Object id, Object value) {
	    ...
	    case 108:
		   register.setRegName((String)value); 
		   break;
	    case 109:
	    	int i=((Integer)value).intValue();
		    register.setService((FinderServiceKind)services.get(i)); 
		    break;
