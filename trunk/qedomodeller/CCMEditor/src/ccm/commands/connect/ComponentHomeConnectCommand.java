 ...
 * @author vilapower
 */
public class ComponentHomeConnectCommand extends Command {
	...
	private ComponentDef componentEnd;
	 ...
	 */			
	public ComponentHomeConnectCommand() {
		super();
	}
	/**
	 * @see org.eclipse.gef.commands.Command
	 */			
	public ComponentHomeConnectCommand(String s) {
		super(s);
	}
	...
	*/
	...
	protected void createConnection(){	
	   // homeEnd.setCompHomeRelation(relation);
	    homeEnd.setComponent(componentEnd);
	   // componentEnd.getCompHomeRelation().add(relation);
	    //componentEnd.getHomes().add(homeEnd);
