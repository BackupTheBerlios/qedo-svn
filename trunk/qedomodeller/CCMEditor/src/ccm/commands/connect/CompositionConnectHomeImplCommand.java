 ...
 * @author vilapower
 */
public class CompositionConnectHomeImplCommand extends Command {
	 ...
	 */			
	public CompositionConnectHomeImplCommand() {
		super();
	}
	/**
	 * @see org.eclipse.gef.commands.Command
	 */			
	public CompositionConnectHomeImplCommand(String s) {
		super(s);
	}
	...
	*/
	public void execute() {
	    ...
	    compositionEnd=(Composition) source.getContained();
	    homeImplEnd=(HomeImplDef ) target.getContained();
