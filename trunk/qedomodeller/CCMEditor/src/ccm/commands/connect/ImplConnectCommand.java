 ...
 * @author Siegercn
 */
public class ImplConnectCommand extends Command {
	...
	private String type;
	private ImplDef implEnd;
	private AbstractInterfaceDef  abstractInterfaceEnd;
	 ...
	 */			
	public ImplConnectCommand() {
		super();
	}
	/**
	 * @see org.eclipse.gef.commands.Command
	 */			
	public ImplConnectCommand(String s) {
		super(s);
		this.type=s;
	}
	...
	*/	
	public void undo() {
	    ...
	    if(implEnd instanceof HomeImplDef)
	    	((HomeImplDef)implEnd).setHome(null);
	    else 
	    	((ComponentImplDef)implEnd).setComponent(null);
