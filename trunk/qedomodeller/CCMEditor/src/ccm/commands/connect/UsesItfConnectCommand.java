 ...
 * @author vilapower
 */
public class UsesItfConnectCommand extends Command {
	 ...
	 */			
	public UsesItfConnectCommand() {
		super();
	}
	/**
	 * @see org.eclipse.gef.commands.Command
	 */			
	public UsesItfConnectCommand(String s) {
		super(s);
	}
	...
	*/
	public void execute() {
	  ...
	  //  relation=factory.createInterfaceRelation();
	    ...
	    description.setLabel( CCMConstants.USES_INTERFACE_LABEL);
	...
	protected void createConnection(){	
	   ...
	   // port.getInterfaceRelation().add(relation);
