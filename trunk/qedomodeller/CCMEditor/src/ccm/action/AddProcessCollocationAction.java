 ...
 * @author siegercn
 */
public class AddProcessCollocationAction extends SelectionAction {
	
//	The command type as string value
	private final String commandType;
	
	// The name shown in the Context-Menu
	public static final String CLASSIFIER_PROPERTY = "add a ProcessCollocation";
	 ...
	 * @param commandType
	 */
	public AddProcessCollocationAction(IWorkbenchPart part, String commandType){
		super(part);
		...
		if(selectedEditParts.get(0) instanceof EditPart) {
			...
			if (part instanceof AssemblyNodeEditPart ||
				...
				//else {
					...
					CreateProcessCollocationCommand command = new CreateProcessCollocationCommand();
					...
					command.setNewObject(factory.createProcessCollocation());
