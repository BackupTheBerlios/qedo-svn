 ...
 * @author siegercn
 */
public class ContainedFileAction extends SelectionAction {
	
//	The command type as string value
	private final String commandType;
	
	// The name shown in the Context-Menu
	public static final String CLASSIFIER_PROPERTY = "add contained file";
	 ...
	 * @param commandType
	 */
	public ContainedFileAction(IWorkbenchPart part, String commandType){
		super(part);
		...
		if(selectedEditParts.get(0) instanceof EditPart) {
			...
			if (part instanceof DeploymentUnitNodeEditPart ||
				...
				//else {
					...
					AddContainedFileCommand command = new AddContainedFileCommand();
					...
					command.setNewObject(factory.createContainedFile());
