...
//	The command type as string value
	...
	public static final String CLASSIFIER_PROPERTY = "add a property";
	 ...
	 * @param commandType
	 */
	public PropertyAction(IWorkbenchPart part, String commandType){
		super(part);
		...
		if(selectedEditParts.get(0) instanceof EditPart) {
			...
			if (part instanceof DeploymentUnitNodeEditPart ||part instanceof HomeInstanceNodeEditPart||
				...
				//else {
					...
					command.setNewObject(factory.createProperty());
