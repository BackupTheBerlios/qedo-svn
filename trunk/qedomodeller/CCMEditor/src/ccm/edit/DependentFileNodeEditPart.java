 ...
 * @author siegercn
 */
public class DependentFileNodeEditPart
     ...
     * @param node
     */
    public DependentFileNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public DependentFileNodeEditPart(){}
	...
	public DependentFile getFile(){
		return (DependentFile) ((Node)getModel()).getContained();
	}
