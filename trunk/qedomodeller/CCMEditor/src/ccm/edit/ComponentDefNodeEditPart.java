...
public class ComponentDefNodeEditPart
     ...
     * @param node
     */
    public ComponentDefNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public ComponentDefNodeEditPart(){}
	...
	protected void refreshVisuals() {
		...
		//Dimension newDim = fig.getPreferredSize(0,0);
		if(dim.equals(-1,-1)){
	...
	protected IPropertySource getPropertySource() {
		propertySource = new ComponentDefPropertySource( getModelNode().getContained() );
