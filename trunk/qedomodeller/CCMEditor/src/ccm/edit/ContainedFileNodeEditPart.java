 ...
 * @author siegercn
 */
public class ContainedFileNodeEditPart
    ...
    public IFigure getContentPane() {
        return getFileFigure().getPaneFigure();
    }
     ...
     * @param node
     */
    public ContainedFileNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public ContainedFileNodeEditPart(){}
	...
	public ContainedFile getFile(){
		return (ContainedFile) ((Node)getModel()).getContained();
	}
	...
	*/
	...
	protected void refreshVisuals() {
		getFileFigure().setIdentifier(getFile().getIdentifier());
		Rectangle r;
	...
	private ContainedWithMembersFigure getFileFigure(){
	...
	protected IFigure createFigure() {
		ContainedWithMembersFigure opFigure=new ContainedWithMembersFigure(getFile().getIdentifier(),ProjectResources.CONTAINEDFILE);
		return opFigure;
	}
	/**
	...
	protected IPropertySource getPropertySource() {
			propertySource = new ContainedFilePropertySource( getModelNode().getContained() );
