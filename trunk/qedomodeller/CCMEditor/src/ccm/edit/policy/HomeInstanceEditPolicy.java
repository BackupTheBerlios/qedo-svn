...
public class HomeInstanceEditPolicy extends GraphicalNodeEditPolicy {

    
	public HomeInstanceEditPolicy() {
		super();
	}
	...
	protected Command getConnectionCompleteCommand(CreateConnectionRequest request) {
		if(request.getStartCommand() instanceof InterfaceConnectCommand ){
		    ...
		    command.setTarget(((HomeInstanceNodeEditPart)getHost()).getModelNode());
