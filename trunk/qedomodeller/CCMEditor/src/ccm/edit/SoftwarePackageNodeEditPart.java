...
public class SoftwarePackageNodeEditPart
     ...
     * @param node
     */
    public SoftwarePackageNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public SoftwarePackageNodeEditPart(){}
	
	public SoftwarePackage getPackage(){
		return (SoftwarePackage)((Node) getModel()).getContained();
	}
    
	/*
	 * return the figure casted to CORBAComponent
	 */
	public ContainerFigure getUnitFigure(){
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE, new SoftwarePackageXYLayoutEditPolicy());
		installEditPolicy(EditPolicy.CONTAINER_ROLE, new ModelEditPolicy());	
		installEditPolicy( EditPolicy.GRAPHICAL_NODE_ROLE, new SoftwarePackageEditPolicy() );
	}
	...
	protected void refreshVisuals() {
		...
		//ContainerFigure fig = getUnitFigure();
		//fig.setIdentifier(getPackage().getIdentifier());
	...
	public void notifyChanged(Notification notification) {
		...
		switch( featureId ) {
			case CCMNotificationImpl.DeploymentUnit:	
    ...
    public IFigure getContentPane() {
         return getUnitFigure().getFiguresPanel();
    	//return null;
    }
 ...
 public ConnectionAnchor getSourceConnectionAnchor(ConnectionEditPart connection) {
     return getUnitFigure().getIncomingConnectionAnchor();
 }
 ...
 public ConnectionAnchor getTargetConnectionAnchor(ConnectionEditPart connection) {
     return getUnitFigure().getOutgoingConnectionAnchor();
 }
