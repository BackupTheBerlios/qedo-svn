 ...
 * @author siegercn
 */
public class DeploymentrequirementNodeEditPart
     ...
     * @param node
     */
    public DeploymentrequirementNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public DeploymentrequirementNodeEditPart(){}
	...
	public Deploymentrequirement getRequirment(){
		return (Deploymentrequirement) ((Node)getModel()).getContained();
	}
	...
	*/
	...
	protected void refreshVisuals() {
		getRequirmentFigure().setIdentifier(getRequirment().getIdentifier());
		Rectangle r;
	...
	protected IFigure createFigure() {
		ContainedWithMembersFigure opFigure=new ContainedWithMembersFigure(getRequirment().getIdentifier(),ProjectResources.REQUIREMENT);
		return opFigure;
	}
	/**
	...
	protected IPropertySource getPropertySource() {
			propertySource = new DeploymentRequirementPropertySource( getModelNode().getContained() );
