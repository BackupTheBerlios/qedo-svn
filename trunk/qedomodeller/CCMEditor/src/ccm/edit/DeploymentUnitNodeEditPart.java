...
public class DeploymentUnitNodeEditPart
     ...
     * @param node
     */
    public DeploymentUnitNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public DeploymentUnitNodeEditPart(){}
	
	public Implementation getUnit(){
		return (Implementation)((Node) getModel()).getContained();
	}
    
	/*
	 * return the figure casted to CORBAComponent
	 */
	public ContainerFigureWithAttribute getUnitFigure(){
	...
	protected void createEditPolicies() {
		...
		installEditPolicy( EditPolicy.GRAPHICAL_NODE_ROLE, new DeploymentunitEditPolicy() );
	}
	...
	protected void refreshVisuals() {
		...
		ContainerFigureWithAttribute fig = getUnitFigure();
		fig.setName(getUnit().getIdentifier());
    ...
    public IFigure getContentPane() {
         return getUnitFigure().getAttributeFigure();
    	//return null;
    }
