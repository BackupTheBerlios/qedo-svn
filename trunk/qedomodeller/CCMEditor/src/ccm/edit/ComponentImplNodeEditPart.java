...
import ccm.edit.policy.ComponentImplEditPolicy;
...
public class ComponentImplNodeEditPart
     ...
     * @param node
     */
    public ComponentImplNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public ComponentImplNodeEditPart(){}
	
	public ComponentImplDef getComponentImpl(){
		return (ComponentImplDef)((Node) getModel()).getContained();
	}
    
	/*
	 * return the figure casted to CORBAComponent
	 */
	public ContainerFigureWithAttribute getComponentImplFigure(){
	...
	protected void createEditPolicies() {
		...
		installEditPolicy( EditPolicy.GRAPHICAL_NODE_ROLE, new ComponentImplEditPolicy() );
	}
	...
	protected void refreshVisuals() {
		...
		ContainerFigureWithAttribute fig = getComponentImplFigure();
		fig.setName(getComponentImpl().getIdentifier());
		//fig.setAttributeLabels(new String[]{"category:"+getComponentImpl().getCategory().toString()});
	...
	protected IFigure createFigure() {
		ContainerFigureWithAttribute  ComponentImplFigure=new ContainerFigureWithAttribute(getComponentImpl().getIdentifier(),ccm.ProjectResources.COMPONENTIMPL,
                null);
//compositionFigure.setName(getComposition().getIdentifier());
        return ComponentImplFigure;
}
	...
	public void notifyChanged(Notification notification) {
		...
		switch( featureId ) {
			case CCMNotificationImpl.COMPONENTIMPL:	
	...
	protected IPropertySource getPropertySource() {
		propertySource = new ComponentImplPropertySource( getModelNode().getContained() );
    ...
    public IFigure getContentPane() {
        return getComponentImplFigure().getAttributeFigure();
    	//return null;
    }
 ...
 public ConnectionAnchor getSourceConnectionAnchor(ConnectionEditPart connection) {
     return getComponentImplFigure().getIncomingConnectionAnchor();
 }
 ...
 public ConnectionAnchor getTargetConnectionAnchor(ConnectionEditPart connection) {
     return getComponentImplFigure().getOutgoingConnectionAnchor();
 }
