...
import ccm.edit.policy.HomeImplEditPolicy;
...
public class HomeImplNodeEditPart
     ...
     * @param node
     */
    public HomeImplNodeEditPart(Node clr){
		setModel(clr);
    }
	
    public HomeImplNodeEditPart(){}
	
	public HomeImplDef getHomeImpl(){
		return (HomeImplDef)((Node) getModel()).getContained();
	}
    
	/*
	 * return the figure casted to CORBAComponent
	 */
	public ContainerFigureWithAttribute getHomeImplFigure(){
	...
	protected void createEditPolicies() {
		...
		installEditPolicy( EditPolicy.GRAPHICAL_NODE_ROLE, new HomeImplEditPolicy() );
	}
	...
	protected void refreshVisuals() {
		...
		ContainerFigureWithAttribute fig = getHomeImplFigure();
		fig.setName(getHomeImpl().getIdentifier());
	...
	protected IFigure createFigure() {
		ContainerFigureWithAttribute  ComponentImplFigure=new ContainerFigureWithAttribute(getHomeImpl().getIdentifier(),ccm.ProjectResources.HOMEIMPL_S,
               null);
//compositionFigure.setName(getComposition().getIdentifier());
	...
	public void notifyChanged(Notification notification) {
		...
		switch( featureId ) {
			case CCMNotificationImpl.HOMEIMPL:	
	...
	protected IPropertySource getPropertySource() {
		propertySource = new HomeImplPropertySource( getModelNode().getContained() );
    ...
    public IFigure getContentPane() {
        return getHomeImplFigure().getAttributeFigure();
    }
 ...
 public ConnectionAnchor getSourceConnectionAnchor(ConnectionEditPart connection) {
     return getHomeImplFigure().getIncomingConnectionAnchor();
 }
 ...
 public ConnectionAnchor getTargetConnectionAnchor(ConnectionEditPart connection) {
     return getHomeImplFigure().getOutgoingConnectionAnchor();
 }
