...
public class SampleNewWizardPage extends WizardPage {
	...
	public SampleNewWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("CCM-Designer");
		setDescription("This wizard creates a new file with *.ccm extension that can be opened by a multi-page editor.");
