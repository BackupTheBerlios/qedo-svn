...
*@author Siegercn
*/
public class CreatePropertyDialog extends org.eclipse.swt.widgets.Dialog {
		...
		private ElementName service;
		private ElementName[] services={ElementName.SEQUENCE_EL_LITERAL,ElementName.SIMPLE_EL_LITERAL,
				ElementName.STRUCT_EL_LITERAL,ElementName.VALUETYPE_EL_LITERAL};
		...
		public CreatePropertyDialog(Shell parent, int style) {
			super(parent, style);
		...
		*/
		public void open(){
			try {
				...
				dialogShell.setText("Add Property");
				...
				FormData  TxtLData = new FormData();
				 TxtLData.height = 13;
				 TxtLData.width = 342;
				 TxtLData.left =  new FormAttachment(252, 1000, 0);
				...
				idlTypeLbLData.right =  new FormAttachment(246, 1000, 0);
		...
		protected void serviceCmbWidgetSelected(SelectionEvent evt) {
			setService(services[idlTypeCmb.getSelectionIndex()]);
		 ...
		 * @param kind
		 */
		private void setService(ElementName kind) {
			service=kind;
	...
	//	}
		...
		public void postInitGUI(){
		    ...
		    idlTypeCmb.add("SEQUENCE_EL");
		    idlTypeCmb.add("SIMPLE_EL");
		    idlTypeCmb.add("STRUCT_EL");
		    idlTypeCmb.add("VALUETYPE_EL");
		    idlTypeCmb.select(0);
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreatePropertyDialog inst = new CreatePropertyDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
