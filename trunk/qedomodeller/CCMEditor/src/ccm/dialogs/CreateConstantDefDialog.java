...
*/
public class CreateConstantDefDialog extends org.eclipse.swt.widgets.Dialog {
	...
	public CreateConstantDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Add Constant");
			...
			idlBtnLData.top =  new FormAttachment(709, 1000, 0);
			idlBtnLData.bottom =  new FormAttachment(863, 1000, 0);
			...
			constValueLb.setText("Constant Value:");
