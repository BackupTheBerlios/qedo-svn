...
*@author Siegercn
*/
public class EditEnumMumberDialog extends org.eclipse.swt.widgets.Dialog  implements KeyListener{
	...
	public EditEnumMumberDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Edit EnumMumber");
