...
public class CreateImplementationDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public CreateImplementationDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Add Implementation");
			dialogShell.setSize(new org.eclipse.swt.graphics.Point(476,155));
			...
			composite2.setSize(new org.eclipse.swt.graphics.Point(464,110));
			...
			discTypeCmbLData.left =  new FormAttachment(239, 1000, 0);
			discTypeCmbLData.right =  new FormAttachment(996, 1000, 0);
			discTypeCmbLData.top =  new FormAttachment(1010, 1250, 0);
			discTypeCmbLData.bottom =  new FormAttachment(1240, 1250, 0);
			discTypeCmb.setLayoutData(discTypeCmbLData);
			discTypeCmb.setSize(new org.eclipse.swt.graphics.Point(204,27));
			 
			discTypeCmb.setFont(repositoryIdTxtfont);
			...
			discriminatorTypeLbLData.left =  new FormAttachment(11, 1000, 0);
			discriminatorTypeLbLData.right =  new FormAttachment(235, 1000, 0);
			discriminatorTypeLbLData.top =  new FormAttachment(1015, 1250, 0);
			discriminatorTypeLbLData.bottom =  new FormAttachment(1240, 1250, 0);
			discriminatorTypeLb.setLayoutData(discriminatorTypeLbLData);
			discriminatorTypeLb.setText("Composition:");
			discriminatorTypeLb.setSize(new org.eclipse.swt.graphics.Point(120,19));
			discriminatorTypeLb.setEnabled(true);
			discriminatorTypeLb.setFont(isLocalBtnfont);
			...
			repositoryIdTxtLData.top =  new FormAttachment(290, 1250, 0);
			repositoryIdTxtLData.bottom =  new FormAttachment(520, 1250, 0);
			...
			versionTxtLData.top =  new FormAttachment(530, 1250, 0);
			versionTxtLData.bottom =  new FormAttachment(760, 1250, 0);
			...
			uuidTxtLData.top =  new FormAttachment(770, 1250, 0);
			uuidTxtLData.bottom =  new FormAttachment(1000, 1250, 0);
			...
			identifierTxtLData.top =  new FormAttachment(48, 1250, 0);
			identifierTxtLData.bottom =  new FormAttachment(280, 1250, 0);
			...
			uuidLbLData.top =  new FormAttachment(780, 1250, 0);
			uuidLbLData.bottom =  new FormAttachment(1000, 1250, 0);
			...
			versionLbLData.top =  new FormAttachment(540, 1250, 0);
			versionLbLData.bottom =  new FormAttachment(760, 1250, 0);
			...
			repositoryIdLbLData.top =  new FormAttachment(300, 1250, 0);
			repositoryIdLbLData.bottom =  new FormAttachment(525, 1250, 0);
			...
			idLbLData.top =  new FormAttachment(53, 1250, 0);
			idLbLData.bottom =  new FormAttachment(290, 1250, 0);
			...
			Rectangle bounds = dialogShell.computeTrim(0, 0, 476,155);
	 ...
	 public void setCompsitions( List compositionList) {
        
         this.compositions=compositionList.toArray();
     }
	/**
	 * @param evt
	 */
	protected void discTypeCmbWidgetSelected(SelectionEvent evt) {
		setComposition((Composition)compositions[discTypeCmb.getSelectionIndex()]);
	}
	...
	public void postInitGUI(){
	    ...
	    for(int i =0;i<compositions.length;i++){
	    	discTypeCmb.add(((Composition)compositions[i]).getIdentifier());
	    }
	}
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateAssemblyDialog inst = new CreateAssemblyDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
