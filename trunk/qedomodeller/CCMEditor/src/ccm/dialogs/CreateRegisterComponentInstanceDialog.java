...
*@author Siegercn
*/
public class CreateRegisterComponentInstanceDialog extends org.eclipse.swt.widgets.Dialog {
		...
		public CreateRegisterComponentInstanceDialog(Shell parent, int style) {
			super(parent, style);
			this.parent=parent;
		}
		...
		*/
		public void open(){
			try {
				...
				featureCmb = new Combo(composite2,SWT.READ_ONLY);
				featureLb = new Label(composite2,SWT.NULL);
				...
				dialogShell.setText("Add RegisterComInstance");
				...
				FormData  CmbLData = new FormData();
				 CmbLData.height = 27;
				 CmbLData.width = 306;
				 CmbLData.left =  new FormAttachment(252, 1000, 0);
				 CmbLData.right =  new FormAttachment(996, 1000, 0);
				 CmbLData.top =  new FormAttachment(848, 1000, 0);
				 CmbLData.bottom =  new FormAttachment(1000, 1000, 0);
				featureCmb.setLayoutData( CmbLData);
				featureCmb.setSize(new org.eclipse.swt.graphics.Point(306,27));
				featureCmb.setFont(constValueTxtfont);
				featureCmb.addSelectionListener( new SelectionAdapter() {
					public void widgetSelected(SelectionEvent evt) {
						featureCmbWidgetSelected(evt);
					}
				});
				...
				FormData  LbLData = new FormData();
				 ...
				 LbLData.right =  new FormAttachment(141, 1000, 0);
				 LbLData.top =  new FormAttachment(850, 1000, 0);
				 LbLData.bottom =  new FormAttachment(1000, 1000, 0);
				featureLb.setLayoutData( LbLData);
				featureLb.setText("Feature:");
				featureLb.setSize(new org.eclipse.swt.graphics.Point(60,27));
				featureLb.setFont(idlBtnfont);
				...
				idlTypeCmbLData.top =  new FormAttachment(682, 1000, 0);
				idlTypeCmbLData.bottom =  new FormAttachment(838, 1000, 0);
				...
				idlTypeLbLData.top =  new FormAttachment(688, 1000, 0);
				idlTypeLbLData.bottom =  new FormAttachment(838, 1000, 0);
				idlTypeLb.setLayoutData(idlTypeLbLData);
				idlTypeLb.setText("Service:");
				idlTypeLb.setSize(new org.eclipse.swt.graphics.Point(60,24));
		 ...
		 * @param evt
		 */
		protected void featureCmbWidgetSelected(SelectionEvent evt) {
			feature =(ComponentFeature) features.get(featureCmb.getSelectionIndex());
	...
	//	}
		...
		public void postInitGUI(){
		    ...
		    for (Iterator it =features.iterator();it.hasNext();){
		    	featureCmb.add(((Contained)it.next()).getIdentifier());
		    }
		    featureCmb.select(0);
		    feature=(ComponentFeature)features.get(0);
		    }
		}
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreateRegisterComponentInstanceDialog inst = new CreateRegisterComponentInstanceDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
