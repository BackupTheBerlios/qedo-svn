...
*/
public class CreateModuleDefDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public CreateModuleDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateModuleDefDialog inst = new CreateModuleDefDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
