...
*/
public class CreateValueMemberDefDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	private Button isPublicMemberBtn;
	...
	public CreateValueMemberDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	protected void enterMouseDown(MouseEvent evt){
	    ...
	    isPublicMember=isPublicMemberBtn.getSelection();
	    state=true;
	    dialogShell.close();
	}
	...
	*/
	public void open(){
		try {
			...
			isPublicMemberBtn = new Button(composite2,SWT.CHECK| SWT.RIGHT);
			...
			dialogShell.setText("Add Value Member");
			dialogShell.setSize(new org.eclipse.swt.graphics.Point(476,185));
		...
		//	final Font discLbfont = new Font(Display.getDefault(),"Tahoma",12,1);
			...
			idlBtnLData.left =  new FormAttachment(938, 1000, 0);
			idlBtnLData.right =  new FormAttachment(998, 1000, 0);
			idlBtnLData.top =  new FormAttachment(525, 1000, 0);
			idlBtnLData.bottom =  new FormAttachment(687, 1000, 0);
			...
			final Font idlBtnfont1 = new Font(Display.getDefault(),"Tahoma",7,1);
			...
			FormData isPublicMemberBtnLData = new FormData();
			isPublicMemberBtnLData.height = 20;
			isPublicMemberBtnLData.width = 129;
			isPublicMemberBtnLData.left =  new FormAttachment(231, 1000, 0);
			isPublicMemberBtnLData.right =  new FormAttachment(992, 1000, 0);
			isPublicMemberBtnLData.top =  new FormAttachment(720, 1000, 0);
			isPublicMemberBtnLData.bottom =  new FormAttachment(916, 1000, 0);
			isPublicMemberBtn.setLayoutData(isPublicMemberBtnLData);
			isPublicMemberBtn.setAlignment(SWT.LEFT);
			isPublicMemberBtn.setText("is public member");
			isPublicMemberBtn.setSize(new org.eclipse.swt.graphics.Point(129,20));
			isPublicMemberBtn.setEnabled(true);
			isPublicMemberBtn.setFont(idlBtnfont);
	
			FormData idlTypeCmbLData = new FormData();
			idlTypeCmbLData.height = 27;
			idlTypeCmbLData.width = 305;
			idlTypeCmbLData.left =  new FormAttachment(231, 1000, 0);
			idlTypeCmbLData.right =  new FormAttachment(934, 1000, 0);
			idlTypeCmbLData.top =  new FormAttachment(515, 1000, 0);
			idlTypeCmbLData.bottom =  new FormAttachment(662, 1000, 0);
			idlTypeCmb.setLayoutData(idlTypeCmbLData);
			idlTypeCmb.setSize(new org.eclipse.swt.graphics.Point(305,27));
	//		final Font idlBtnfont = new Font(Display.getDefault(),"Tahoma",10,0);
			idlTypeCmb.setFont(idlBtnfont1);
			...
			idlTypeLbLData.top =  new FormAttachment(525, 1000, 0);
			idlTypeLbLData.bottom =  new FormAttachment(672, 1000, 0);
			...
			repositoryIdTxtLData.left =  new FormAttachment(231, 1000, 0);
			...
			repositoryIdTxt.setFont(idlBtnfont);
			...
			versionTxtLData.left =  new FormAttachment(231, 1000, 0);
			...
			versionTxt.setFont(idlBtnfont1);
			...
			identifierTxtLData.left =  new FormAttachment(231, 1000, 0);
			...
			identifierTxt.setFont(idlBtnfont1);
			...
			versionLbLData.right =  new FormAttachment(227, 1000, 0);
			versionLbLData.top =  new FormAttachment(363, 1000, 0);
			...
			repositoryIdLbLData.right =  new FormAttachment(227, 1000, 0);
			repositoryIdLbLData.top =  new FormAttachment(202, 1000, 0);
			...
			idLbLData.right =  new FormAttachment(227, 1000, 0);
			idLbLData.top =  new FormAttachment(40, 1000, 0);
			...
			Rectangle bounds = dialogShell.computeTrim(0, 0, 476,185);
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateValueMemberDefDialog inst = new CreateValueMemberDefDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
