...
* *************************************
*/
public class AddReceptacleDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	private boolean isMultipleItf=false;
	...
	public AddReceptacleDialog(Shell parent, int style, String text) {
		super(parent, style);
		setText(text);
	}
...
*/
			...
			versionTxtLData.left =  new FormAttachment(272, 1000, 0);
			versionTxtLData.right =  new FormAttachment(976, 1000, 0);
			versionTxtLData.top =  new FormAttachment(490, 1000, 0);
			versionTxtLData.bottom =  new FormAttachment(690, 1000, 0);
			...
			versionLbLData.top =  new FormAttachment(428, 1000, 0);
			versionLbLData.bottom =  new FormAttachment(572, 1000, 0);
			...
			repositoryIDTxtLData.left =  new FormAttachment(272, 1000, 0);
			repositoryIDTxtLData.right =  new FormAttachment(976, 1000, 0);
			repositoryIDTxtLData.top =  new FormAttachment(270, 1000, 0);
			repositoryIDTxtLData.bottom =  new FormAttachment(480, 1000, 0);
			...
			repositoryIDLbLData.top =  new FormAttachment(266, 1000, 0);
			repositoryIDLbLData.bottom =  new FormAttachment(474, 1000, 0);
			...
			nameTxtLData.left =  new FormAttachment(272, 1000, 0);
			nameTxtLData.right =  new FormAttachment(976, 1000, 0);
			nameTxtLData.top =  new FormAttachment(43, 1000, 0);
			nameTxtLData.bottom =  new FormAttachment(253, 1000, 0);
			...
			nameLbLData.bottom =  new FormAttachment(206, 1000, 0);
			nameLb.setLayoutData(nameLbLData);
			nameLb.setText("Identifier:");
			nameLb.setFont(idlBtnfont);
			{
				multipleCheck = new Button(composite2, SWT.CHECK | SWT.LEFT);
				multipleCheck.setText("is multiple");
				FormData multipleCheckLData = new FormData();
				multipleCheck.setFont(idlBtnfont);
				multipleCheckLData.height = 52;
				multipleCheckLData.width = 154;
				multipleCheckLData.left =  new FormAttachment(272, 1000, 0);
				multipleCheckLData.right =  new FormAttachment(619, 1000, 0);
				multipleCheckLData.top =  new FormAttachment(690, 1000, 0);
				multipleCheckLData.bottom =  new FormAttachment(930, 1000, 0);
				multipleCheck.setLayoutData(multipleCheckLData);
				multipleCheck.setEnabled(true);
			}
			...
			cancelLData.left =  new FormAttachment(800, 1000, 0);
			...
			Rectangle bounds = dialogShell.computeTrim(0, 0, 400,154);
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			AddReceptacleDialog inst = new AddReceptacleDialog(shell, SWT.NULL, "");
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void enterMouseDown(MouseEvent evt){
	    ...
	    state=true;
	    isMultipleItf=multipleCheck.getSelection();
	    dialogShell.close();
	}
	...
	/**
	 * @return Returns the isMultipleItf.
	 */
	public boolean isMultipleItf() {
		return isMultipleItf;
	}
