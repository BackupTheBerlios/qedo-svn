...
*@author Siegercn
*/
public class EditFieldDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public EditFieldDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Edit Fields");
			...
			final Font btFont = new Font(Display.getDefault(),"Tahoma",9,1);
			final Font mlabel = new Font(Display.getDefault(),"Tahoma",8,1);
