...
*/
public class CreateExceptionDefDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public CreateExceptionDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Add Exception");
			dialogShell.setSize(new org.eclipse.swt.graphics.Point(407,389));
		...
		//	final Font label1font = new Font(Display.getDefault(),"Tahoma",12,1);
			...
			typeCodeTxtLData.left =  new FormAttachment(269, 1000, 0);
			...
			discriminatorTypeLbLData.right =  new FormAttachment(269, 1000, 0);
			...
			discriminatorTypeLb.setText("Type Code:");
			...
			parLData.height = 233;
			parLData.width = 293;
			parLData.left =  new FormAttachment(269, 1000, 0);
			...
			nameTxtLData.left =  new FormAttachment(269, 1000, 0);
			...
			Rectangle bounds = dialogShell.computeTrim(0, 0, 407,389);
