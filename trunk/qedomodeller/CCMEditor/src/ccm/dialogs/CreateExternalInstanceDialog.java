...
*@author Siegercn
*/
public class CreateExternalInstanceDialog extends org.eclipse.swt.widgets.Dialog {
	   ...
	   // private Shell parent ;
		...
		public CreateExternalInstanceDialog(Shell parent, int style) {
			super(parent, style);
			//this.parent=parent;
		}
		...
		*/
		public void open(){
			try {
				...
				dialogShell.setText("Add ExternalInstance");
	...
	//	}
		...
		public void postInitGUI(){
		    ...
		    idlTypeCmb.add("HOMEFINDER");
		    idlTypeCmb.add("NAMING");
		    idlTypeCmb.add("TRADING");
		    idlTypeCmb.add("UNDEFINED");
		    idlTypeCmb.select(0);
		...
		* However, if you delete this method it will not be re-created.	*/
		public static void showGUI(){
			try {
				...
				CreateExternalInstanceDialog inst = new CreateExternalInstanceDialog(shell, SWT.NULL);
				inst.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
