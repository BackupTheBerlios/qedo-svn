...
*/
public class CreateAbstractInterfaceDefDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public CreateAbstractInterfaceDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	* However, if you delete this method it will not be re-created.	*/
	public static void showGUI(){
		try {
			...
			CreateAbstractInterfaceDefDialog inst = new CreateAbstractInterfaceDefDialog(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
