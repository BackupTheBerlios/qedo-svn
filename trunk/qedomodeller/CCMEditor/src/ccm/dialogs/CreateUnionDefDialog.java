...
*/
public class CreateUnionDefDialog extends org.eclipse.swt.widgets.Dialog  implements KeyListener{
	...
	public CreateUnionDefDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	protected void enterMouseDown(MouseEvent evt){
	    ...
	    idlTemp.setIndexOfIDLType(discTypeCmb.getSelectionIndex());
	    state=true;
	    dialogShell.close();
	}
	...
	*/
	public void open(){
		try {
			...
			idlBtnLData.height = 20;
			idlBtnLData.width = 38;
			idlBtnLData.left =  new FormAttachment(898, 1000, 0);
			idlBtnLData.right =  new FormAttachment(993, 1000, 0);
			idlBtnLData.top =  new FormAttachment(213, 1000, 0);
			idlBtnLData.bottom =  new FormAttachment( 275, 1000, 0);
			idlBtn.setLayoutData(idlBtnLData);
			idlBtn.setText("....");
			idlBtn.setSize(new org.eclipse.swt.graphics.Point(38,20));
			...
			discTypeCmbLData.right =  new FormAttachment(896, 1000, 0);
			discTypeCmbLData.top =  new FormAttachment(210, 1000, 0);
			discTypeCmbLData.bottom =  new FormAttachment(281, 1000, 0);
			...
			discriminatorTypeLbLData.top =  new FormAttachment(216, 1000, 0);
			discriminatorTypeLbLData.bottom =  new FormAttachment(272, 1000, 0);
			discriminatorTypeLb.setLayoutData(discriminatorTypeLbLData);
			discriminatorTypeLb.setText("Discr. Type:");
			...
			parLbLData.right =  new FormAttachment(228, 1000, 0);
			parLbLData.top =  new FormAttachment(296, 1000, 0);
			...
			parLData.height = 233;
			parLData.width = 293;
			parLData.left =  new FormAttachment(266, 1000, 0);
	...
	public void postInitGUI(){
	    ...
	    while(it.hasNext()){
	        ...
	        discTypeCmb.add(idl.toString());
	    }
	    discTypeCmb.select(0);
	...
	* However, if you delete this method it will not be re-created.	*/
	...
	protected void idlBtnMouseDown(MouseEvent evt){
	    ...
	    if(idlTemp.getIdlKind().getValue()!=IDLKind.IDL){
	        discTypeCmb.remove(discTypeCmb.getItemCount()-1);
	    }
