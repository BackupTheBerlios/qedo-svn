...
public class CreateComponentImplDialog extends org.eclipse.swt.widgets.Dialog implements KeyListener{
	...
	public CreateComponentImplDialog(Shell parent, int style) {
		super(parent, style);
	}
	...
	*/
	public void open(){
		try {
			...
			dialogShell.setText("Add ComponentImpl");
	...
	public void postInitGUI(){
	    ...
	    for(int i =0;i<components.length;i++){
	    	discTypeCmb.add(((ComponentDef)components[i]).getIdentifier());
	    }
	...
	* However, if you delete this method it will not be re-created.	*/
	...
	protected void discTypeCmbWidgetSelected(SelectionEvent evt){
		...
		setComponent((ComponentDef)components[discTypeCmb.getSelectionIndex()]);
	}
