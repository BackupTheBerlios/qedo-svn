...
# ADD LINK32 ComponentIDL.lib CosNamingd.lib obd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../Runtime/tc_omg.exe" /pdbtype:sept /libpath:"$(ORBACUS)\lib" /libpath:"$(QEDO)/ComponentIDL/Debug_orbacus_vc6/"
