...
# ADD LINK32 ComponentIDL.lib obd.lib jtcd.lib /nologo /dll /debug /machine:I386 /out:"../../../../Runtime/philosopherE.dll" /pdbtype:sept /libpath:"$(QEDO)/ComponentIDL/ComponentIDL___Win32_Debug_orbacus_vc6" /libpath:"$(ORBACUS)\lib"
