...
# ADD LINK32 CosNamingd.lib obd.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug_orbacus_vc6/csa.exe" /pdbtype:sept /libpath:"$(ORBACUS)\lib"
# Begin Special Build Tool
TargetPath=.\Debug_orbacus_vc6\csa.exe
SOURCE="$(InputPath)"
...
LINK32=link.exe
# ADD BASE LINK32 CosNamingd.lib obd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../Runtime/csa.exe" /pdbtype:sept /libpath:"$(ORBACUS)\lib"
# ADD LINK32 aced.lib TAOd.lib TAO_PortableServerd.lib TAO_DynamicAnyd.lib TAO_CosNamingd.lib TAO_IFR_Clientd.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug_tao/csa.exe" /pdbtype:sept /libpath:"$(ACE_ROOT)\ace" /libpath:"$(TAO)\TAO\tao" /libpath:"$(TAO)\TAO\tao\PortableServer" /libpath:"$(TAO)\TAO\tao\DynamicAny" /libpath:"$(TAO)\TAO\orbsvcs\orbsvcs" /libpath:"$(TAO)\TAO\tao\IFR_Client"
# Begin Special Build Tool
TargetPath=.\Debug_tao\csa.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Distribution:
PostBuild_Cmds=mkdir $(QEDO)\bin	copy $(TargetPath) $(QEDO)\bin
# End Special Build Tool
