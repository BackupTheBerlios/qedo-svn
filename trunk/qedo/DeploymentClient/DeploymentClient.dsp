...
!MESSAGE 
!MESSAGE "DeploymentClient - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "DeploymentClient - Win32 Debug_orbacus" (based on "Win32 (x86) Console Application")
!MESSAGE "DeploymentClient - Win32 Release_orbacus" (based on "Win32 (x86) Console Application")
!MESSAGE "DeploymentClient - Win32 Debug_mico" (based on "Win32 (x86) Console Application")
!MESSAGE "DeploymentClient - Win32 Debug_tao" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
LINK32=link.exe
# ADD BASE LINK32 CosNamingd.lib obd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../Runtime/deploy.exe" /pdbtype:sept /libpath:"$(ORBACUS)\lib"
# ADD LINK32 aced.lib TAOd.lib TAO_PortableServerd.lib TAO_DynamicAnyd.lib TAO_CosNamingd.lib TAO_IFR_Clientd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../Runtime/deploy.exe" /pdbtype:sept /libpath:"$(ACE_ROOT)\ace" /libpath:"$(TAO)\TAO\tao" /libpath:"$(TAO)\TAO\tao\PortableServer" /libpath:"$(TAO)\TAO\tao\DynamicAny" /libpath:"$(TAO)\TAO\orbsvcs\orbsvcs" /libpath:"$(TAO)\TAO\tao\IFR_Client"
