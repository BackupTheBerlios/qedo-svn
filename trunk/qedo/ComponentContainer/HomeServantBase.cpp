...
HomeServantBase::lookup_servant (const PortableServer::ObjectId& object_id)
{
	...
	//servant -> set_servant_dispatcher (
	//	Components::ContainerPortableInterceptor::ServantContainerInterceptorRegistration::_duplicate(container_ -> servant_reg));
	servant -> set_servant_dispatcher (container_ -> servant_dispatcher_);
