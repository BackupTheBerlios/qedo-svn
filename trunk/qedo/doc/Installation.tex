...
\section{Cygwin}
\label{sec:CYGWIN}
For several tasks in the process of compiling Qedo some tools are needed (e.g. zip, flex, bison). Those tools are usually not available on windows systems though you can use cygwin. Cygwin offers a variety of unix tools for Windows systems. You can obtain the latest version of Cygwin from \verb http://www.cygwin.com .
