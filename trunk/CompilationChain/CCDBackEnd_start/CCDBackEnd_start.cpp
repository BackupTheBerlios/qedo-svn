...
static char rcsid[] = "$Id: CCDBackEnd_start.cpp,v 1.2 2004/06/15 12:12:10 jre Exp $";
...
#endif//ORBACUS_ORB
#ifdef MICO_ORB
	ccd_servant.append("\\CCMGenerator_CCDBackEnd_compo_SERVANT.dll");
	ccd_exec.append("\\CCMGenerator_CCDBackEnd_compo.dll");
#endif//MICO_ORB
#else//!_WIN32
#ifdef ORBACUS_ORB
